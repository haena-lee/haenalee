<?php
/**
 * haenalee functions and definitions
 *
...
if ( ! function_exists( 'haenalee_setup' ) ) :
	/**
	 ...
	 */
	function haenalee_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on haenalee, use a find and replace
		 * to change 'haenalee' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'haenalee', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'haenalee_custom_background_args', array(
...
add_action( 'after_setup_theme', 'haenalee_setup' );
 ...
 */
function haenalee_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'haenalee_content_width', 640 );
}
add_action( 'after_setup_theme', 'haenalee_content_width', 0 );
 ...
 */
function haenalee_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'haenalee' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'haenalee' ),
...
add_action( 'widgets_init', 'haenalee_widgets_init' );
...
function haenalee_scripts() {
	...
	wp_enqueue_script( 'haenalee-scroll-top', get_template_directory_uri() . '/js/scroll-top.js', array('jquery'), '20181018', true );
...
add_action( 'wp_enqueue_scripts', 'haenalee_scripts' );
